...
public class CustomLayoutDialog extends Dialog implements View.OnClickListener {
    ...
    public CustomLayoutDialog(Context context, int alertType) {
    ...
    public CustomLayoutDialog setTitleText(String text) {
        mTitleText = text;
    ...
    public CustomLayoutDialog setContentText(String text) {
        mContentText = text;
    ...
    public CustomLayoutDialog showContentText(boolean isShow) {
        mShowContent = isShow;
