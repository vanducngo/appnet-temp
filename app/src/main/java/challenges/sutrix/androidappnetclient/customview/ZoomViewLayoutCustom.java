...
package challenges.sutrix.androidappnetclient.customview;
 ...
 */
public class ZoomViewLayoutCustom extends RelativeLayout {
    /**
    ...
    public ZoomViewLayoutCustom(Context context) {
        super(context);
        init();
    }

    public ZoomViewLayoutCustom(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ZoomViewLayoutCustom(Context context, AttributeSet attrs, int defStyle) {
